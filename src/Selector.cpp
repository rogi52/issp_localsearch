...
vector<vector<double>> Selector::select(string algorithm) {
    if(algorithm == "fils") return local_search();
    if(algorithm == "fils-nlist") return local_search_with_nearest_list();
    if(algorithm == "fils-rlist") return local_search_with_random_list();
    if(algorithm == "fils-rlist-nlist") return two_phase_local_search();
    cerr << "Error. " << algorithm << " is not defined" << endl;
    exit(1);
}

vector<vector<double>> Selector::local_search() {
...
vector<vector<double>> Selector::local_search_with_nearest_list() {
    vector<vector<double>> point_subset;
...
vector<vector<double>> Selector::local_search_with_random_list() {
    vector<vector<double>> point_subset;
...
vector<vector<double>> Selector::two_phase_local_search() {
    vector<vector<double>> point_subset;
